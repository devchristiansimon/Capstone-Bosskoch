...
export default function AddReceipt({receiptList, newReceipt, setNewReceipt, inputValue, setInputValue, ingredients,  setIngredients }:{receiptList: Receipt[], newReceipt: Receipt, setNewReceipt: (Receipt:Receipt) => void, inputValue: string, setInputValue: (value: string) => void, ingredients: string[], setIngredients: (ingredients: string[]) => void }){
                    ...
                    <div>
                        ...
                        <div className={"inRow"}>
                            <div className={"labelInputBox"}>
                                ...
                                <input name={"difficulty"} type={"radio"} id={"easy"} value={"Leicht"}
                                       onChange={handleOnChange}/>
                            </div>
                            <div className={"labelInputBox"}>
                                <label htmlFor={"easy"}>Mittel</label>
                                <input name={"difficulty"} type={"radio"} id={"medium"} value={"Mittel"}
                                       onChange={handleOnChange}/>
                            </div>
                            <div className={"labelInputBox"}>
                                <label htmlFor={"hard"}>Schwer</label>
                                <input name={"difficulty"} type={"radio"} id={"hard"} value={"Schwer"}
                                       onChange={handleOnChange}/>
                            </div>
                ...
                <div className={"ingredientListContainer"}>
                    <ul>
                        {ingredients.map((ingredient, index) => (
                            <li key={index} onClick={() => deleteIngredients(index)}
                                className={"ingredientList"}>{ingredient}</li>
                        ))}
                    </ul>
                </div>
            </div>
